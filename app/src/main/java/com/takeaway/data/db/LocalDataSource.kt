...
class LocalDataSource(private val database: RestaurantDatabase, private val preferences: Where2EatPreferences) {
    ...
    //    public Observable<List<Restaurant>> save(final List<Restaurant> restaurants) {
    //        return Observable.fromCallable(new Callable<List<Restaurant>>() {
    //            @Override
